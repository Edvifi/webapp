import type { CollegeInfo } from '../collegeData'

/**
 * TEST FIXTURE ONLY — a snapshot of curated colleges so the unit tests have
 * stable data without a database. App code loads colleges from the Supabase
 * `colleges` table and never imports this file.
 */
export const COLLEGE_FIXTURES: CollegeInfo[] = [
  // ─── UC Schools ───────────────────────────────────────────
  {
    id: 'ucla',
    name: 'UCLA',
