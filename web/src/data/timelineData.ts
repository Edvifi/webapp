...
export const milestones: Milestone[] = [
  // ── FRESHMAN ──────────────────────────────────────────────────────────────
  {
    id: 'f1', emoji: '🏗️', yearLabel: 'Freshman Year', grade: '9th',
  ...
  // ── SOPHOMORE ─────────────────────────────────────────────────────────────
  {
    id: 's1', emoji: '📈', yearLabel: 'Sophomore Year', grade: '10th',
  ...
  // ── JUNIOR ────────────────────────────────────────────────────────────────
  {
    id: 'j1', emoji: '⚡', yearLabel: 'Junior Year', grade: '11th',
  ...
  // ── SENIOR ────────────────────────────────────────────────────────────────
  {
    id: 'sr1', emoji: '✍️', yearLabel: 'Senior Year', grade: '12th',
...
export const TOTAL = milestones.length

export function yearGroupOf(idx: number): YearGroup {
